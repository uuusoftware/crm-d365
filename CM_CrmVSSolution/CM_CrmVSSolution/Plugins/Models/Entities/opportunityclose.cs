...
namespace Plugins.Models
{
	...
	public partial class OpportunityClose : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public partial class Fields
		{
			...
			public const string cm_SPFlag = "cm_spflag";
			public const string cm_spflagName = "cm_spflagname";
		...
		/// <summary>
		/// Confirm that Insurance certificates are verified and attached.
		/// </summary>
		...
		/// <summary>
		/// Confirm if onboarding form has been filled.
		/// </summary>
		...
		/// <summary>
		/// Confirm that Other necessary documents have been completed and attached.
		/// </summary>
		...
		/// <summary>
		/// Confirm if Vendor onboarding form is completed.
		/// </summary>
		...
		/// <summary>
		/// Recycled number from the portal
		/// </summary>
		...
		/// <summary>
		/// Link to the provincial schedule
		/// </summary>
		...
		/// <summary>
		/// Service Provider Flag if the related Opp is Service Provider to validate Opp close fields before saving the record.
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("cm_spflag")]
		public System.Nullable<bool> cm_SPFlag
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("cm_spflag");
			}
			set
			{
				this.OnPropertyChanging("cm_SPFlag");
				this.SetAttributeValue("cm_spflag", value);
				this.OnPropertyChanged("cm_SPFlag");
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("cm_spflagname")]
		public string cm_spflagName
		{
			get
			{
				if (this.FormattedValues.Contains("cm_spflag"))
				{
					return this.FormattedValues["cm_spflag"];
				}
				else
				{
					return default(string);
		...
		public Plugins.Models.Account account_OpportunityCloses
		{
			get
			{
				return this.GetRelatedEntity<Plugins.Models.Account>("account_OpportunityCloses", null);
			}
			set
			{
				this.OnPropertyChanging("account_OpportunityCloses");
				this.SetRelatedEntity<Plugins.Models.Account>("account_OpportunityCloses", null, value);
		...
		public Plugins.Models.Incident incident_OpportunityCloses
		{
			get
			{
				return this.GetRelatedEntity<Plugins.Models.Incident>("incident_OpportunityCloses", null);
			}
			set
			{
				this.OnPropertyChanging("incident_OpportunityCloses");
				this.SetRelatedEntity<Plugins.Models.Incident>("incident_OpportunityCloses", null, value);
		...
		public Plugins.Models.Lead lead_OpportunityCloses
		{
			get
			{
				return this.GetRelatedEntity<Plugins.Models.Lead>("lead_OpportunityCloses", null);
			}
			set
			{
				this.OnPropertyChanging("lead_OpportunityCloses");
				this.SetRelatedEntity<Plugins.Models.Lead>("lead_OpportunityCloses", null, value);
		...
		public Plugins.Models.Opportunity Opportunity_OpportunityClose
		{
			get
			{
				return this.GetRelatedEntity<Plugins.Models.Opportunity>("Opportunity_OpportunityClose", null);
			}
			set
			{
				this.OnPropertyChanging("Opportunity_OpportunityClose");
				this.SetRelatedEntity<Plugins.Models.Opportunity>("Opportunity_OpportunityClose", null, value);
		...
		public Plugins.Models.Opportunity opportunity_OpportunityCloses
		{
			get
			{
				return this.GetRelatedEntity<Plugins.Models.Opportunity>("opportunity_OpportunityCloses", null);
			}
			set
			{
				this.OnPropertyChanging("opportunity_OpportunityCloses");
				this.SetRelatedEntity<Plugins.Models.Opportunity>("opportunity_OpportunityCloses", null, value);
		...
		public Plugins.Models.Team team_opportunityclose
		{
			get
			{
