...
namespace Plugins.Models
{
	...
	public partial class cm_ProgramAssociation : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public partial class Fields
		{
			...
			public const string cm_CaseProgramAssociation = "cm_caseprogramassociation";
			public const string cm_CaseProgramAssociationName = "cm_caseprogramassociationname";
			...
			public const string cm_ProgramforChecklistItem = "cm_programforchecklistitem";
			public const string cm_ProgramforChecklistItemName = "cm_programforchecklistitemname";
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("cm_caseprogramassociation")]
		public Microsoft.Xrm.Sdk.EntityReference cm_CaseProgramAssociation
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("cm_caseprogramassociation");
			}
			set
			{
				this.OnPropertyChanging("cm_CaseProgramAssociation");
				this.SetAttributeValue("cm_caseprogramassociation", value);
				this.OnPropertyChanged("cm_CaseProgramAssociation");
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("cm_caseprogramassociationname")]
		public string cm_CaseProgramAssociationName
		{
			get
			{
				if (this.FormattedValues.Contains("cm_caseprogramassociation"))
				{
					return this.FormattedValues["cm_caseprogramassociation"];
				}
				else
				{
					return default(string);
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("cm_programforchecklistitem")]
		public Microsoft.Xrm.Sdk.EntityReference cm_ProgramforChecklistItem
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("cm_programforchecklistitem");
			}
			set
			{
				this.OnPropertyChanging("cm_ProgramforChecklistItem");
				this.SetAttributeValue("cm_programforchecklistitem", value);
				this.OnPropertyChanged("cm_ProgramforChecklistItem");
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("cm_programforchecklistitemname")]
		public string cm_ProgramforChecklistItemName
		{
			get
			{
				if (this.FormattedValues.Contains("cm_programforchecklistitem"))
				{
					return this.FormattedValues["cm_programforchecklistitem"];
				}
				else
				{
					return default(string);
		...
		/// <summary>
		/// N:1 cm_programassociation_CaseProgramAssociation_incident
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("cm_caseprogramassociation")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("cm_programassociation_CaseProgramAssociation_incident")]
		public Plugins.Models.Incident cm_programassociation_CaseProgramAssociation_incident
		{
			get
			{
				return this.GetRelatedEntity<Plugins.Models.Incident>("cm_programassociation_CaseProgramAssociation_incident", null);
			}
			set
			{
				this.OnPropertyChanging("cm_programassociation_CaseProgramAssociation_incident");
				this.SetRelatedEntity<Plugins.Models.Incident>("cm_programassociation_CaseProgramAssociation_incident", null, value);
		...
		/// <summary>
		/// N:1 cm_programassociation_ProgramforChecklistItem_cm_casechecklistcatalog
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("cm_programforchecklistitem")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("cm_programassociation_ProgramforChecklistItem_cm_casechecklistcatalog")]
		public Plugins.Models.cm_CaseChecklistCatalog cm_programassociation_ProgramforChecklistItem_cm_casechecklistcatalog
		{
			get
			{
				return this.GetRelatedEntity<Plugins.Models.cm_CaseChecklistCatalog>("cm_programassociation_ProgramforChecklistItem_cm_casechecklistcatalog", null);
			}
			set
			{
				this.OnPropertyChanging("cm_programassociation_ProgramforChecklistItem_cm_casechecklistcatalog");
				this.SetRelatedEntity<Plugins.Models.cm_CaseChecklistCatalog>("cm_programassociation_ProgramforChecklistItem_cm_casechecklistcatalog", null, value);
