...
(function (CM) {
    var LeadRibbon = /** @class */ (function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, Xrm.WebApi.retrieveMultipleRecords(Lead.EntityLogicalName, "?$select=statuscode&$filter=leadid eq ".concat(leadId))];
                        case 1:
                            lead = _b.sent();
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 3:
                            _b.sent();
                            leadRecord = (_a = {},
                                _a["statecode" /* Lead.Attributes.statecode */] = 1 /* LeadEnum.statecode.Qualified */,
                                _a);
                            return [4 /*yield*/, Xrm.WebApi.updateRecord(Lead.EntityLogicalName, leadId, leadRecord)];
                        case 4:
                            isUpdated = _b.sent();
                            return [3 /*break*/, 7];
                        case 5:
        ...
        LeadRibbon.notifyUser = function (formContext, message) {
            ...
            setTimeout(function () { return formContext.ui.clearFormNotification(formNotificationKey); }, LeadRibbon.Constants.Delay.POPUP_MS);
        };
        ...
        LeadRibbon.Constants = {
            OptionSets: { QUALIFIED: 1 },
            Delay: { REFRESH_MS: 3000, POPUP_MS: 15000 },
        };
        return LeadRibbon;
    }());
    CM.LeadRibbon = LeadRibbon;
})(CM || (CM = {}));
